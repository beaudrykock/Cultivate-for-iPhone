...
#define SHKMyAppName			@"Cultivate"
#define SHKMyAppURL				@"http://www.cultivateoxford.org"
...
#define SHKFacebookAppID      @"204006546353102"
#define SHKFacebookLocalAppID      @""
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"34ep2Qg6A47d9L6698g7a45c86d9Aa57"
 ...
 */
#define SHKTwitterConsumerKey		@"c3zabWvHN3dsZxvGkcuYw"
#define SHKTwitterSecret			@"VofLcjNrVWd7qk5rBN28cLLYlM3RDvr8iGwZFVMrOso"
#define SHKTwitterCallbackUrl		@"http://www.cultivateoxford.org" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
*/
#define SHKEvernoteUserStoreURL		@"https://sandbox.evernote.com/edam/user"
#define SHKEvernoteSecretKey		@"34b37d476d084463"
#define SHKEvernoteConsumerKey		@"bek_bwc"
#define SHKEvernoteNetStoreURLBase	@"http://sandbox.evernote.com/edam/note/"

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"betterworldcoding"
#define SHKBitLyKey					@"R_e8c4097b6e3bd8faba643ac51cba0b76"
...
#define SHKFormBgColorRed			9.0 // Value between 0-255, set all to -1 for default
#define SHKFormBgColorGreen			40.0 // Value between 0-255, set all to -1 for default
#define SHKFormBgColorBlue			68.0 // Value between 0-255, set all to -1 for default
